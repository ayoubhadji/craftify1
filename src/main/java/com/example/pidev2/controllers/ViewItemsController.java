...
import com.example.pidev2.service.SliderItemService;
...
public class ViewItemsController {
    ...
    private void handleGoToFoireList(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/pidev2/viewFoire.fxml"));
    ...
    private void handleAddItem(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/pidev2/addItem.fxml"));
            Parent root = loader.load();
    ...
    private void handleModifyItem(SliderItem selectedItem) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/pidev2/updateItem.fxml"));
            Parent root = loader.load();
