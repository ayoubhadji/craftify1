...
public class AfficherParticipationController implements Initializable {
    ...
    void handleModifier(ActionEvent event) {
        ...
        if (selectedParticipation != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/yasmine/ModifierParticipation.fxml"));
    ...
    void handleAjouter(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/yasmine/AjouterParticipation.fxml"));
            Parent root = loader.load();
    ...
    private void handleRetourEvenements() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/yasmine/AfficherEvenement.fxml"));
            Parent root = loader.load();
